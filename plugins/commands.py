...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://t.me/+3glT2avj1lg4ZGFl')
            ],
            [
                InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://t.me/new_movie_i24"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ Movies Request Group ⚡', url=f"https://t.me/+_-9trQQYYFczNTJl"),
            InlineKeyboardButton('🔔 Movie Channel 🤖', url='https://t.me/new_movie_i24')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('🤤𝐃𝐄𝐒𝐈 𝐕𝐈𝐃𝐄𝐎𝐒💦', url='https://t.me/+EY_4ESZbuSA2NzY1)] ] ),
        protect_content=True if pre == 'filep' else False,
        )
